...
namespace AerLingus.Controllers
{
    public class FlightRecordsController : Controller
    {
        ...
        public async Task<ActionResult> Upload(HttpPostedFileBase file)
        {
            ...
            List<Flight_Records> lista = new List<Flight_Records>();
            ...
            try
            {
                ...
                {
                    footerArray = streamReader1.ReadLine().Split(separator, StringSplitOptions.None);
                    numberOfRecords++;
                }
